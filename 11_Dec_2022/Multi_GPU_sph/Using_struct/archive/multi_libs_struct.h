...
// smoothing_h_mgpu<<<gridSize, blockSize>>>(beg[i], end[i], d_p[i], Ndown, Nup, coeff, Nngb_f, dt, N);

//========================================
//======= Smoothing Length (MGPUs) struct ======= Updated: 28 Jan 2023. h_new adopted from eq.31 in Gadget2 Paper
//========================================
...
//============ getDensity - MGPUs ==================
//==========================================
__global__ void getDensity_mgpu(int Nbeg, int Nend, int *Typ, float *x, float *y, float *z, float *mass,
...
//================= acc_g - MGPUs ======================
//==============================================
__global__ void acc_g_mgpu(int Nbeg, int Nend, int *Typ, float *x, float *y, float *z, float *eps, float *accx,

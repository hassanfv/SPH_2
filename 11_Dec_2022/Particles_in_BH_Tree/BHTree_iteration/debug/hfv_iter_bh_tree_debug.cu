                                  ...
                                  float *left, float *right, float *bottom, float *top, int n, int m)
{
	...
	while((bodyIndex + offset) < n)
	{
		...
		//printf("x, y, temp, childPath, stride = %f, %f, %d, %d, %d\n",
		//          x[bodyIndex + offset], y[bodyIndex + offset], temp, childPath, stride);
		...
		while(childIndex >= n)
		{
		  ...
		  //printf("childIndex = %d\n", childIndex);
		  //printf("temp, bodyIndex, childIndex = %d, %d, %d\n", temp, bodyIndex, childIndex);

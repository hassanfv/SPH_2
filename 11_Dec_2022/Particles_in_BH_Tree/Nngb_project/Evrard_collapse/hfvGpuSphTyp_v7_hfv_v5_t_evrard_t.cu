...
#include <random>
#include <tuple>
#include "hfvCLibs_v7_hfv_v2.h" // I used my grid method.
...
//--------------------------------------------
  ...
  */
  ...
  for (int i = 48990; i < 49000; i++)
  {
    cout << "i, rho[i] After = " << i << ", " << rho[i] << endl;
  }
  ...
  cout << "sph acc calculation Successful!!." << endl;
  ...
  */
  ...
  while (t < tEnd)
  {
    ...
    cout << "r evolution Successful!!." << endl;

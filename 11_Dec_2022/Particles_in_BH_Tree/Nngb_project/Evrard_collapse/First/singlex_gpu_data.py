...
ax[0].scatter(rr, vv, s = 0.1, alpha = 1.0, color = 'k', label='This work')
ax[0].scatter(rG, vr, s = 0.1, color = 'lime', label = 'Gadget 4')
...
ax[1].scatter(rG, rhoG, s = 0.1,  color = 'lime', label = 'Gadget 4')
...
ax[2].scatter(rG, PG, s = 0.1, color = 'lime', label = 'Gadget 4')

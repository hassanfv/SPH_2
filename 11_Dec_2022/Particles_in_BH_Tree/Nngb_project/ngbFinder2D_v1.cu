...
__host__ __device__ int getCelliD(float x, float y, float x_min, float y_min, float Wcell, int nSplit)
{
...
int main()
{
  ...
  int cell_t = getCelliD(x[i], y[i], x_min, y_min, W_cell, nSplit);

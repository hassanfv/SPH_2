...
//==================== update_t_last ========================
//===========================================================
__global__ void update_t_last_activeId(int *Typ, float *t_last, float *t_next, int *activeId,
                                       float *dt_i, float t, float dt, int N)
{
  ...
  if ((i < N) && (Typ[i] == 0))
  {
    ...
    float half_dt = 0.5f * dt; // use this for float number precision!
    if ((t_next[i] >= t - half_dt) && (t_next[i] >= t + half_dt))
    {
      activeId[i] = 1;
      t_last[i] = t;
...
//==================== who_is_active ========================
//===========================================================
__global__ void who_is_active(int *Typ, int *activeIndx, float *t_next,
                              float dt, float t, int N)
{
...
//==================== update_t_next ========================
//===========================================================
__global__ void update_t_next(int *Typ, float *t_last, float *t_next,

...
R_s_0, v_s_0, E_b_0, E_th_0 = [1.0009194678803323e+21,51238158.87490803,2.6419038029960226e+56,2.5715134605749287e+55]

S_0 = (R_s_0, v_s_0, E_b_0, E_th_0) # initial condition vector !

yrs = 4e5 * 365.25 * 24 * 3600

t = np.linspace(11547293773738.59, yrs, int(1e5))

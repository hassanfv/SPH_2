...
string RESTART = "yes"; // options = yes or no (note they are in lower case letters)!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
int main()
{
  ...
  if (RESTART != "yes")
  {
    string fname = "GPU_IC_DLA_50k.csv"; //!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  if (RESTART == "yes")
  {
    string fname = "RESTART_0.015751.csv"; //!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  float ref_dt_cgs = 10.0f * 365.24f * 24.0f * 3600.0f; // i.e 100 years.

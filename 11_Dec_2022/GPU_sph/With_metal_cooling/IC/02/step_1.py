...
Mcld_in_g = 3677.912 * MSun # !!!!!!!!!!!!!!!!!! calculated using the nH_M_R_estimator.py code here !
Rcld_in_pc = 30.0         # !!!!!!!!!!!!!!!!!!
...
u = 200.0 + np.zeros(Npart) # in code unit # !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! I used check4.py code here to find this value!

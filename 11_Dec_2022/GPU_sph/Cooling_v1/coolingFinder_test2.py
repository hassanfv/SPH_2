...
#------- applyCooling -------
def applyCooling(uad, rho, delta_u, ref_dt_cgs, uGrid, rhoGrid, MIN_uad, MAX_uad, MIN_rho, MAX_rho, ut_cgs, rhot_cgs, current_dt_cgs):
	...
	return uad[nxx] - coeff * delta_u[nxx]

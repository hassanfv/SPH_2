...
MAX_dt_code_unit = 0.1 * ref_dt_cgs / unitTime_in_s;
dt = MAX_dt_code_unit
...
for j in range(0, 120, 1):
	...
	res.append([t, u[jj], upre[jj], rho[jj], dudt[jj]])
...
for k in range(len(u)):
	...
	print(f'{upreX:.4E}, {uX:.4E}, {rhoX:.4E}, {dU:.4E}, {uX - upreX:.4E}')


plt.scatter(t, u, s = 5, color = 'black')
plt.scatter(t, upre, s = 5, color = 'blue')
#plt.scatter(tad, uad, s = 10, color = 'red')
plt.xlabel('t')
plt.ylabel('u_j')

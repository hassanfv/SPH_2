...
Mcld_in_g = 136.219 * MSun # calculated using the nH_M_R_estimator.py code here !
Rcld_in_pc = 100.0
...
print()
print('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!')
print('PLEASE UPDATE MACH NUMBER IN step4.py !!!!!!!')
print('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!')
print()
...
u = 36000.0 + np.zeros(Npart) # in code unit # I used check4.py code here to find this value!

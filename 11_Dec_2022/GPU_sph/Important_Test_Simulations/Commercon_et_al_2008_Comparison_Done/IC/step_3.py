...
NSample = 200000 # The desired number of particles to be included in ONE cloud in the IC.
NSample = int(NSample)

with open('Main_IC_Grid_678k.pkl', 'rb') as f:
	data = pickle.load(f)
...
print('********************************************')
print()
print('np.sort(rho) (physical unit) = ', np.sort(rho) * UnitDensity_in_cgs)

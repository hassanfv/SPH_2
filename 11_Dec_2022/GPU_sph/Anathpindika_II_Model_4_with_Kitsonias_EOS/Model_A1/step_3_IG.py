...
NSample = 30000 # The desired number of particles to be included in ONE cloud in the IC.
NSample = int(2 * NSample)

with open('clouds_31k_RAND.pkl', 'rb') as f:
	data = pickle.load(f)
...
Unit_time_in_Myrs = (UnitRadius_in_cm**3/grav_const_in_cgs/UnitMass_in_g)**0.5 / 3600/24/365.25/1e6
print('Unit_time_in_Myrs = ', Unit_time_in_Myrs)
print('********************************************')
print()

...
mSPH_high = 80 # Msun #!!!!!!!!!!!!!!!!!!!!!!!
N_high = 500000 # This is the number of particles for only the high res octant! #!!!!!!!!!!!!!!!!!!!!!!!

mSPH_low = 760 # Msun #!!!!!!!!!!!!!!!!!!!!!!!
N_low = 60000 # This is the number of particles for each low-res octant. In total, it will be 7 * N_low for all 7 low-res octants!#!!!!!!!!!!!!!!!!!!!!!!!
...
for x in np.arange(0, L_box/2, stp_high):
  for y in np.arange(0, L_box/2, stp_high):
    for z in np.arange(0, L_box/2, stp_high):
      ...
      xx = random.uniform(0, L_box/2)
      yy = random.uniform(0, L_box/2)
      zz = random.uniform(0, L_box/2)
      ...
      for xi in np.arange(x, x + L_box/2, stp_low):
        for yi in np.arange(y, y + L_box/2, stp_low):
          for zi in np.arange(z, z + L_box/2, stp_low):
            ...
            xx = random.uniform(x, x + L_box/2)
            yy = random.uniform(y, y + L_box/2)
            zz = random.uniform(z, z + L_box/2)
...
if rank == 0:
    ...
    N_blank = 10000  #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! May need to change !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

...
mSPH_high = 50 # Msun
N_high = 250000 # This is the number of particles for only the high res octant!

mSPH_low = 400 # Msun
N_low = 30000 # This is the number of particles for each low-res octant. In total, it will be 7 * N_low for all 7 low-res octants!

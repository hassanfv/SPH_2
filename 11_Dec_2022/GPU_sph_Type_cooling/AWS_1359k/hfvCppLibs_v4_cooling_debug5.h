...
void saveArraysToBinary(const std::string &filename, float *x, float *y, float *z, float *vx, float *vy, float *vz,
                        float *rho, float *h, float *u, float *uBAd, float *uAC, float *mass, float *dudt, float *dudt_pre,
                        int *Typ, int N)
{
...
__global__ void hcooling(int *Typ, float *u, float *U, float *rho, float Zmetal, float dt, // Zmetal is the gass metallicity assumed.
                         float *nHGrid, float *ZGrid, float *uEvol, float *tArr_sec, float *x, float *y, float *z,
                         ...
                         int N_kpc, int N_nH, int N_Z, int N_T, int N_Time, int N)
{

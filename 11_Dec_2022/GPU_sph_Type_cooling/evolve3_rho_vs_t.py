...
def loadArraysFromBinary(filename):
    ...
    return N, Typ, x, y, z, rho, u, uBAd, uAC, mass, dudt, utprevious
...
for j, filename in enumerate(filz):
  ...
  # Usage
  N, Typ, x, y, z, rho, u, uBAd, uAC, mass, dudt, utprevious = loadArraysFromBinary(filename)
  ...
  XH = 0.7
  unit_rho = 3.0455065067933682e-24

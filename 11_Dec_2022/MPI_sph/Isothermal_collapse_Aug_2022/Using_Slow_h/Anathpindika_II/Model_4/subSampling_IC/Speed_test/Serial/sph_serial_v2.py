...
while t < tEnd:
	...
	T_h = time.time()
	h_previous = h.copy()
	#h = do_smoothingX2(r, h_previous)
	#h, Niter = do_smoothingX3(r, h_previous)
	h = do_smoothingX4(r, h_previous)
	print('T_h = ', time.time() - T_h)
	print()
	print('h = ', np.sort(h))
	#print('Max Niter = ', max(Niter))
	print()
	#----------------------

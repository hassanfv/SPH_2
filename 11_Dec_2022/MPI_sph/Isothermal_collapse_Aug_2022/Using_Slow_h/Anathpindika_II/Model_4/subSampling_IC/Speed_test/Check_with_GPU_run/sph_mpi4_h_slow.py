...
#with open('IC_Anathpin_100k_RAND.pkl', 'rb') as f:
#	data = pickle.load(f)

df = pd.read_csv('GPU_IC_Anathpin_25k_RAND.csv', names = ['x', 'y', 'z', 'vx', 'vy', 'vz', 'm', 'h', 'eps'])
...
c_0 = 110472.50479601684
gamma = 1.6666666666666667
Rcld_in_pc = 4.543039974566073
Rcld_in_cm = 1.40198213615109e+19
Mcld_in_g = 3.9780000000000003e+36
muu = 2.55
Mach = 3.0
grav_const_in_cgs = 6.67259e-08
G = 1.0

UnitRadius_in_pc = Rcld_in_pc

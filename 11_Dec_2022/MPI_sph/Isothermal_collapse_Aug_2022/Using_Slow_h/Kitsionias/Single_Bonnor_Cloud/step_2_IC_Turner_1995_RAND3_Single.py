...
dictx = {'r': res, 'v': vel, 'h': h, 'm': m, 'rho_cen': rho_0,
	 'Rcld_in_pc': Rcld/3.086e18, 'Mcld': Mcld, 'mu': muu, 'Mach': 0.0} # rho_cen = central density.


with open('IC_Single_BE_' + num + 'k_RAND.pkl', 'wb') as f:
	pickle.dump(dictx, f)
#----------------------------

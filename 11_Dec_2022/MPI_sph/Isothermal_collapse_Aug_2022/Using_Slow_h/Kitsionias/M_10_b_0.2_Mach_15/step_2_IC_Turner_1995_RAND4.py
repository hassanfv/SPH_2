...
# We use entropy in Gadget IC !
# The difference with ...RAND2.py is that here we also create IC for Gadget code.
...
b_param = 0.2 # !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
res[:, 1] = -b_param + res[:, 1] # see Turner et al - 1995
...
Mach = 15. #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
vel_ref = Mach/2.0 * c_s # Only for Kitsionas et al.. Note it is c_s !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1
...
dictx = {'r': res12, 'v': vel, 'h': h, 'm': m, 'rho_cen': rho_0,
	 'Rcld_in_pc': Rcld/3.086e18, 'Mcld': Mcld, 'mu': muu, 'Mach': Mach} # rho_cen = central density.


with open('IC_Kitsionas_' + num + 'k_RAND.pkl', 'wb') as f:
	pickle.dump(dictx, f)
#----------------------------
...
entr = (gamma - 1.0) * u / rhox**(gamma - 1.0)

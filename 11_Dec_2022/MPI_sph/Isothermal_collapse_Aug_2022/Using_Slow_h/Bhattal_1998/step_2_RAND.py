...
dictx = {'r': res, 'v': vel, 'm': m, 'rho_cen': rho_0, 'rho': rho,
	 'Rcld_in_cm': Rcld, 'Rcld_in_pc': Rcld/3.086e18, 'Mcld_in_g': Mcld} # rho_cen = central density.

with open('BE_Sphere.pkl', 'wb') as f:
	pickle.dump(dictx, f)
#----------------------------

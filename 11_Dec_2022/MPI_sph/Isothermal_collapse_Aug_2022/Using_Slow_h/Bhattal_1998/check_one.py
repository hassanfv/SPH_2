...
R_0 = 0.6 # see the printed output of step_2_IC_Turner_1995.py
...
with open('00320.pkl', 'rb') as f:
#with open('./Outputs_1/00150.pkl', 'rb') as f:
	data = pickle.load(f)
...
#ax.scatter(x[nGas], y[nGas], s = 0.05, color = 'red')
...
ax.axis(xmin = -3.2, xmax = 3.2)
ax.axis(ymin = -2.2, ymax = 2.2)



ax.set_title('t = ' + str(np.round(t*unitTime_in_Myr,4)))

plt.savefig('Fig_tmp.png')

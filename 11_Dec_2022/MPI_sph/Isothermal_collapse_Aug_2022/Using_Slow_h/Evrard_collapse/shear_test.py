...
@njit
def getAcc_sph_shear_mpiZZZZZZ(nbeg, nend, pos, v, rho, P, c, h, m, divV, curlV, alpha, beta, eta): # shear viscosity-corrected.
...
@njit
def get_dU_shear_mpiZZZZZ(nbeg, nend, pos, v, rho, P, c, h, m, divV, curlV, alpha, beta, eta):

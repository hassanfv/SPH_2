...
for x in np.arange(0, L_box/2, stp_high):
  for y in np.arange(0, L_box/2, stp_high):
    for z in np.arange(0, L_box/2, stp_high):
      ...
      xx = random.uniform(x, x + stp_high) - L_box_in_kpc / 2.0
      yy = random.uniform(y, y + stp_high) - L_box_in_kpc / 2.0
      zz = random.uniform(z, z + stp_high) - L_box_in_kpc / 2.0
      
      if (np.sqrt(xx*xx + yy*yy + zz*zz) <= L_box/2.0):
      ...
      for xi in np.arange(x, x + L_box/2, stp_low):
        for yi in np.arange(y, y + L_box/2, stp_low):
          for zi in np.arange(z, z + L_box/2, stp_low):
            ...
            xx = random.uniform(xi, xi + stp_low) - L_box_in_kpc / 2.0
            yy = random.uniform(yi, yi + stp_low) - L_box_in_kpc / 2.0
            zz = random.uniform(zi, zi + stp_low) - L_box_in_kpc / 2.0
...
dt = 2e-7 #----> used to estimate the multiplier!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

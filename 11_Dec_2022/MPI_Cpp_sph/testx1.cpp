...
struct Particle
{
  ...
  float accx_sph = 0.0f, accy_sph = 0.0f, accz_sph = 0.0f;
  float accx, accy, accz;
  float rho = 0.0f;
  float P = 0.0f;
  float csnd = 0.0f;
  float divV = 0.0f, curlV = 0.0f;
  float dudt = 0.0f;
  float utprevious = 0.0f;
};
...
int main()
{
  ...
  getPressure_Adiabatic(p, Gamma, N);

  getCsound_Adiabatic(p, Gamma, N);

  div_curlVel(p, N);

  acc_sph(p, visc_alpha, N);

  acc_tot(p, N);

  get_dU(p, visc_alpha, N);
  ...
  for (int i = 0; i < 1705; i++)
  {
    ...
    cout << "h = " << p[i].h << endl;
    cout << "rho = " << p[i].rho << endl;
    cout << "accx_g = " << p[i].accx_g << endl;
    cout << "accy_g = " << p[i].accy_g << endl;
    cout << "accz_g = " << p[i].accz_g << endl;
    cout << "u = " << p[i].u << endl;
    cout << "P = " << p[i].P << endl;
    cout << "csnd = " << p[i].csnd << endl;
    cout << "divV = " << p[i].divV << endl;
    cout << "curlV = " << p[i].curlV << endl;
    cout << "accx_sph = " << p[i].accx_sph << endl;
    cout << "accy_sph = " << p[i].accy_sph << endl;
    cout << "accz_sph = " << p[i].accz_sph << endl;
    cout << "accx = " << p[i].accx << endl;
    cout << "accy = " << p[i].accy << endl;
    cout << "accz = " << p[i].accz << endl;
    cout << "dudt = " << p[i].dudt << endl;
    cout << "u = " << p[i].u << endl;
    cout << "utprevious = " << p[i].utprevious << endl;
    cout << endl;
  }
  */
